...
public class RepuestoUsadoServiceImpl implements RepuestoUsadoService {
    ...
    public RepuestoUsadoDTO crear(RepuestoUsadoDTO dto) {
        ...
        repuesto.setNombre(validarNombre(dto.getNombre(), dto.getDescripcion()));
    ...
    public List<RepuestoUsadoDTO> listar() {
        return repuestoRepository.findAllByOrderByNombreAscDescripcionAsc().stream()
                .map(this::toDTO)
                .toList();
    }
    ...
    public List<RepuestoUsadoDTO> listarDisponibles() {
        return repuestoRepository.findByTareaIsNullOrderByNombreAscDescripcionAsc().stream()
                .map(this::toDTO)
                .toList();
    }
    ...
    public RepuestoUsadoDTO actualizar(Long id, RepuestoUsadoDTO dto) {
        ...
        if (dto.getNombre() != null) {
            String descripcionRef = dto.getDescripcion() != null ? dto.getDescripcion() : repuesto.getDescripcion();
            repuesto.setNombre(validarNombre(dto.getNombre(), descripcionRef));
        }
