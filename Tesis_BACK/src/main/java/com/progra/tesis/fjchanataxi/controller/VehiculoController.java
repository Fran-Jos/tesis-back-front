...
public class VehiculoController {
    ...
    public ResponseEntity<VehiculoDTO> actualizar(@PathVariable("id") @Min(1) Long id, @RequestBody VehiculoDTO dto) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR','TECNICO')")
    public ResponseEntity<VehiculoDTO> buscarPorPlaca(@PathVariable("placa") String placa) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR','TECNICO')")
    public ResponseEntity<VehiculoDTO> buscarPorChasis(@PathVariable("chasis") String chasis) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR','TECNICO')")
    public ResponseEntity<List<VehiculoDTO>> buscarPorMarcaModelo(@RequestParam(name = "marca", required = false) String marca,
    ...
    @GetMapping("/anio")
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR','TECNICO')")
    public ResponseEntity<List<VehiculoDTO>> buscarPorRangoAnio(@RequestParam(name = "desde", required = false) Integer desde,
                                                                @RequestParam(name = "hasta", required = false) Integer hasta) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR','TECNICO')")
    public ResponseEntity<List<VehiculoDTO>> buscarPorEstado(@PathVariable("estado") EstadoVehiculo estado) {
