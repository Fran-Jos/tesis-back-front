...
public class RegistroKilometrajeController {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR','TECNICO')")
    public ResponseEntity<List<RegistroKilometrajeDTO>> listarPorVehiculo(@PathVariable Long vehiculoId) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR','TECNICO')")
    public ResponseEntity<List<RegistroKilometrajeDTO>> listarPorUsuario(@PathVariable Long usuarioId) {
        return ResponseEntity.ok(registroService.listarPorUsuario(usuarioId));
    }

    @GetMapping("/vehiculo/{vehiculoId}/rango")
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR','TECNICO')")
    public ResponseEntity<List<RegistroKilometrajeDTO>> listarPorRango(@PathVariable Long vehiculoId,
    ...
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR','TECNICO')")
    public ResponseEntity<RegistroKilometrajeDTO> ultimo(@PathVariable @Min(1) Long vehiculoId) {
