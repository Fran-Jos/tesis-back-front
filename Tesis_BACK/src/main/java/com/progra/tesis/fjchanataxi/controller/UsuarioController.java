...
public class UsuarioController {
    ...
    public ResponseEntity<UsuarioRespuestaDTO> obtenerPorID(@PathVariable("id") @Min(1) Long id) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN')")
    public ResponseEntity<UsuarioRespuestaDTO> buscarPorCedula(@PathVariable("cedula") String cedula) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN')")
    public ResponseEntity<UsuarioRespuestaDTO> buscarPorEmail(@PathVariable("email") String email) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR')")
    public ResponseEntity<List<UsuarioRespuestaDTO>> buscarPorNombre(@PathVariable("nombre") String nombre) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR')")
    public ResponseEntity<List<UsuarioRespuestaDTO>> buscarPorApellido(@PathVariable("apellido") String apellido) {
    ...
    @GetMapping("/rol/{rol}")
    @PreAuthorize("hasAnyRole('ADMIN')")
    public ResponseEntity<List<UsuarioRespuestaDTO>> buscarPorRol(@PathVariable("rol") Rol rol) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR')")
    public ResponseEntity<List<UsuarioRespuestaDTO>> buscarPorEstado(@PathVariable("estado") EstadoUsuario estado) {
    ...
    @GetMapping("/search")
    @PreAuthorize("hasAnyRole('ADMIN','OPERADOR')")
    public ResponseEntity<List<UsuarioRespuestaDTO>> search(@RequestParam("q") String q) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<UsuarioRespuestaDTO> actualizar(@PathVariable("id") @Min(1) Long id,
