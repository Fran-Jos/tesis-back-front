...
const formatYear = (value: unknown): ReactNode => {
...
export const enumOptions = {
  ...
  severidadAlerta: [
    { value: "VERDE", label: "Informativa" },
    { value: "NARANJA", label: "Próxima" },
    { value: "ROJO", label: "Vencida" },
  ],
};
...
export const entityConfigs: EntityConfig[] = [
  {
    ...
    list: {
      columns: [
        ...
        { field: "anio", label: "Año", render: formatYear },
    ...
    form: {
      fields: [
        ...
        { name: "capacidadCarga", label: "Capacidad de carga (t)", type: "decimal" },
      ...
      fields: [
        ...
        { field: "chasis", label: "Chasis" },
        {
          ...
          render: (value: unknown): ReactNode => {
            ...
            const toneladas = Number(value) / 1000;
            return `${toneladas.toLocaleString("es-EC", { maximumFractionDigits: 2 })} t`;
          },
        },
  ...
  },
  {
    ...
    form: {
      fields: [
        ...
        { name: "frecuenciaKm", label: "Frecuencia en kilómetros", type: "number" },
        { name: "frecuenciaDias", label: "Frecuencia en días", type: "number" },
        { name: "proximoKm", label: "Próximo kilometraje", type: "number" },
  ...
  },
  {
    ...
    form: {
      fields: [
        ...
        { name: "detalle", label: "Detalle", type: "textarea", placeholder: "Describe el trabajo a realizar" },
        {
          name: "responsableId",
          label: "Responsable",
          type: "select",
    ...
    detail: {
      fields: [
        ...
        { field: "cerradoPorNombre", label: "Cerrado por", render: (value: unknown): ReactNode => value ? String(value) : "No registrado" },
        {
          field: "kilometraje",
          label: "Kilometraje",
          render: (value: unknown): ReactNode => value ? `${Number(value).toLocaleString("es-EC")} km` : "No registrado",
        },
        { field: "fechaApertura", label: "Fecha apertura", type: "datetime" },
        { field: "fechaCierre", label: "Fecha cierre", type: "datetime", render: (value: unknown): ReactNode => value ? String(new Intl.DateTimeFormat("es-EC", { year: "numeric", month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit" }).format(new Date(value as string))) : "No registrado" },
      ...
      filters: [
        {
          ...
          required: true,
          fetchOptions: {
            endpoint: "/ordenes/selector",
            valueKey: "id",
            labelKey: "label",
            transformLabel: (orden) => String(orden.label ?? `${orden.codigo as string} | ${orden.vehiculoPlaca as string}`),
          },
        },
      ],
      endpoint: (filters) =>
    ...
    list: {
      ...
      filters: [
        ...
        },
        {
          ...
          type: "select",
          fetchOptions: {
            endpoint: "/tareas/selector",
            valueKey: "id",
            labelKey: "label",
            transformLabel: (tarea) => String(tarea.label ?? `${tarea.nombre as string} | Orden #${tarea.ordenId as number}`),
          },
        },
      ],
      endpoint: (filters) =>
  ...
  },
  {
    ...
    list: {
      columns: [
        ...
        { field: "clasificacion", label: "Clasificación", type: "enum" },
        {
          ...
          label: "Severidad",
          render: (value: unknown): ReactNode => {
            const label = enumOptions.severidadAlerta.find((o) => o.value === value)?.label ?? String(value ?? "-");
            let colorClass = "bg-slate-100 text-slate-700";
            if (value === "VERDE") colorClass = "bg-emerald-100 text-emerald-700";
            if (value === "NARANJA") colorClass = "bg-orange-100 text-orange-700";
            if (value === "ROJO") colorClass = "bg-red-100 text-red-700";
            return createElement(
              "span",
    ...
    form: {
      fields: [
        ...
        { name: "severidad", label: "Severidad", type: "select", options: enumOptions.severidadAlerta, defaultValue: "VERDE" },
    ...
    detail: {
      fields: [
        ...
        { field: "odometroObjetivo", label: "Kilometraje objetivo", type: "number" },
        { field: "estado", label: "Estado", type: "enum" },
      ],
    },
  },
